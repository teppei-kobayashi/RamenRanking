            ...
            <tbody>
                ...
                <c:forEach var="ramen" items="${ramens}" varStatus="status">
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="rament_action"><a href="<c:url value='/ramens/show?id=${ramen.id}' />">詳細を見る</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
        ...
        <div id="pagination">
            ...
            <c:forEach var="i" begin="1" end="${((ramens_count - 1) / 15) + 1}" step="1">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="<c:url value='/ramens/index?page=${i}' />"><c:out value="${i}" /></a>&nbsp;
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        </div>
        <p><a href="<c:url value='/ramens/new' />">新規ラーメンの登録</a></p>
