...
/**
 * Servlet implementation class RamensIndexServlet
 */
@WebServlet("/ramens/index")
public class RamensIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public RamensIndexServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/ramens/index.jsp");
