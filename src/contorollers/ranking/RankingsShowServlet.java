...
/**
 * Servlet implementation class RankingsShowServlet
 */
@WebServlet("/rankings/show")
public class RankingsShowServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public RankingsShowServlet() {
        super();
